...
class Relation{
    /**
     * @var array{0: string, 1: Cardinality} First element is the name of the class 
     * where the relation starts, second element is the cardinality. The cardinality 
    ...
    /**
     * @var array{0: string, 1: Cardinality} First element is the name of the class 
     * where the relation ends, second element is the cardinality. The cardinality 
     * refers to a relationship of "has". Class "foo" has x of other
